...
class TestCourseSearchToolBasicSearch:
    ...
    def test_returns_formatted_string_with_headers(
        self, mock_vector_store_with_results
    ):
    ...
    def test_returns_all_results_joined_by_blank_line(
        self, mock_vector_store_with_results
    ):
    ...
    def test_sources_include_lesson_link_url(self, mock_vector_store_with_results):
        ...
        mock_vector_store_with_results.get_lesson_link.return_value = (
    ...
    def test_sources_url_empty_when_no_lesson_link(
        self, mock_vector_store_with_results
    ):
...
class TestToolManager:
    ...
    def test_get_last_sources_returns_sources_after_search(
        self, mock_vector_store_with_results
    ):
